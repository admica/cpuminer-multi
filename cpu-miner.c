...
{
	printf("** " PACKAGE_NAME " " PACKAGE_VERSION " by admica@github **\n");
	printf("XMR donation addr: 42bnVxoibyRPgPtXszTBNwK7rtSLnpJ8n8AnskymymYJdspAoMC4jsSDnjfeuJ842Fj1SJAAcMhMDXNWcWoJjD6SQuJ2Nvo (admica)\n\n");
}
